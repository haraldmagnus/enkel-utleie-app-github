...
export default function FinancesExpense() {
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => queryClient.invalidateQueries({ queryKey: ['finances-expense'] })
  });
      ...
      <div className="p-4 space-y-4">
        <Card className="bg-red-50 border-red-200">
          <CardContent className="p-3 text-center">
            ...
            <p className="text-xs text-red-600">Totale utgifter</p>
            <p className="font-bold text-red-700">{total.toLocaleString()} kr</p>
          </CardContent>
        </Card>
        ...
        <div className="space-y-2">
          {isLoading ? (
            ...
            <Card><CardContent className="p-8 text-center">
              ...
              <p className="text-slate-500">Ingen utgifter registrert ennå</p>
            </CardContent></Card>
          ) : entries.map(entry => {
              ...
              <Card key={entry.id}>
                <CardContent className="p-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-lg flex items-center justify-center text-lg bg-red-100">
